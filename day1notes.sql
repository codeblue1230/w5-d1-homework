...
-- Query for all first_name data that starts with the letter K and is followed by 2 characters 
-- using the where CLAUSE -- __
SELECT first_name, actor_id 
FROM actor
WHERE first_name
LIKE 'K__';
...
-- Query to display cutomer_ids with summed amounts for each customer_id
